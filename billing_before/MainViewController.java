...
import org.cocos2dx.cpp.billing.BillingManager.BillingUpdatesListener;
...
//    private boolean mGoldYearly;
    ...
    public MainViewController(AppActivity activity) {
...
//                mActivity.alert(R.string.alert_fill_gas, mTank);
                mActivity.onIAPSuccess();
                Log.e(TAG, "onConsumeFinished and success");
            } else {
//                mActivity.alert(R.string.alert_error_consuming, result);
                mActivity.onIAPFailed();
                Log.e(TAG, "onConsumeFinished and failed");
            }
...
//            mGoldYearly = false;
            ...
            Log.e(TAG, "sku purchaseList: " + purchaseList.size());
            for (Purchase purchase : purchaseList) {
//                boolean contains = false;
//                for(int i = 0; i < mActivity.skuList.size(); i++){
//                    if(mActivity.skuList.get(i) == purchase.getSku()){
//                        contains = true;
//                        break;
//                    }
//                }
...
//                }
                ...
                if(purchase.getSku() == "goldenticket1" ||
                        purchase.getSku() == "premium_retry" ||
                        purchase.getSku() == "cc_starter1" ||
                        purchase.getSku() == "cc_starter3" ||
                        purchase.getSku() == "cc_starter10" ||
                        purchase.getSku() == "cc_gem3" ||
                        purchase.getSku() == "cc_gem10" ||
                        purchase.getSku() == "cc_gem50" ||
                        purchase.getSku() == "cc_gem100"){
                    mActivity.onIAPSuccess();
                }
