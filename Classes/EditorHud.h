...
#define BRUSH_EMPTY 0
#define BRUSH_TREE 1
#define BRUSH_MINE 2
#define BRUSH_SWORDSMAN 3
#define BRUSH_ARCHER 4
#define BRUSH_WORKER 5
#define BRUSH_CATAPULT 6
#define BRUSH_HELICOPTER 7
#define BRUSH_CASTLE 8
#define BRUSH_FARM 9
#define BRUSH_BARRACKS 10
#define BRUSH_LUMBERMILL 11
#define BRUSH_WATCHER_TOWER 12
#define BRUSH_FACTORY 13
#define BRUSH_AIRPORT 14
...
public:
    ...
    void addLabelToButton(std::string text, Button* btn, bool bordered, Color3B color);
    Sprite* getIconSprite(std::string itemName);
    Label* lblTyping;
    std::string originalString="";
    void showTyping();
    Node* hudLayer;
    void initQuest(int index, std::string itemName, int count, int max);
    void checkQuestForCollectingItem(std::string name);
    std::string questItemName0;
    std::string questItemName1;
    std::string questItemName2;
    ...
    Node* abDialog = nullptr;
    void showABCDialog(std::string msg, std::string option0, std::string option1, std::string option2);
    ...
    std::string getPIAName(int pia);
    void onAddEventClick();
    void onChangePiaClick();
